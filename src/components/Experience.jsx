  ...
  return (
    <div className="p-3">
      ...
      <div className="text-md md:text-lg md:text-center md:max-w-3xl mx-auto">
        <p>
          I'm a Computer Science graduate and also a FullStack developer with 3+
          years of experience in coding, building and developing interactive web
          applications. I've managed to develop a deep understanding on various
          concepts such as Database management, Routing, Rest APIs, State
          Management (using Redux), JSON, version control using Git, Design just
          to mention few. I also understand on what is expected from me as a
          front-end developer and I’m always open to learning and gathering new
          ideas from others who are in the same industry as me.{" "}
        </p>
      </div>

      <div>
        <h1 className="my-5 text-cyan-600 text-2xl font-semibold text-center">
          skills
        </h1>
